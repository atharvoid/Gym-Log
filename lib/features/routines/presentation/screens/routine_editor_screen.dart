...
class _MultiDayWarningBanner extends StatelessWidget {
  const _MultiDayWarningBanner();
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(
                'This is a multi-day program. Editing here will combine '
                'all days into a single list when you save.',
...
class _RoutineEditorScreenState extends ConsumerState<RoutineEditorScreen> {
  ...
  /// True when the loaded routine has more than one training day (an
  /// imported multi-day program). This editor still saves as one flat,
  /// single-day exercise list, so proceeding here silently collapses every
  /// day onto Day 1. Gated behind an explicit confirm in [_save].
  bool _isMultiDayImported = false;
  ...
  Future<void> _loadExisting() async {
    ...
    if (detail != null) {
      _isMultiDayImported = detail.isMultiDay;
