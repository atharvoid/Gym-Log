...
const _templates = <_RoutineTemplate>[
  ...
  _RoutineTemplate(
    ...
    accent: _cPPL,
    slots: [
      _TemplateSlot('Barbell Bench Press', sets: 4, reps: 6),
      _TemplateSlot('Smith Standing Military Press', sets: 3, reps: 8),
      _TemplateSlot('Barbell Incline Bench Press', sets: 3, reps: 10),
      _TemplateSlot('Cable Lateral Raise', sets: 3, reps: 15),
  ...
  _RoutineTemplate(
    ...
    accent: _cPPL,
    slots: [
      _TemplateSlot('Barbell Deadlift', sets: 3, reps: 5),
      _TemplateSlot('Pull-Up', sets: 4, reps: 8),
      _TemplateSlot('Barbell Bent Over Row', sets: 3, reps: 8),
      _TemplateSlot('Cable Pulldown', sets: 3, reps: 12),
      _TemplateSlot('Dumbbell Reverse Fly', sets: 3, reps: 15),
  ...
  _RoutineTemplate(
    ...
    slots: [
      ...
      _TemplateSlot('Lever Lying Leg Curl', sets: 3, reps: 12),
      _TemplateSlot('Barbell Standing Calf Raise', sets: 4, reps: 15),
    ],
  ),
  _RoutineTemplate(
    ...
    accent: _cPPL,
    slots: [
      _TemplateSlot('Dumbbell Bench Press', sets: 4, reps: 10),
      _TemplateSlot('Barbell Incline Bench Press', sets: 3, reps: 10),
      _TemplateSlot('Lever Shoulder Press', sets: 3, reps: 10),
      _TemplateSlot('Dumbbell Fly', sets: 3, reps: 12),
      _TemplateSlot('Cable Lateral Raise', sets: 4, reps: 15),
  ...
  _RoutineTemplate(
    ...
    slots: [
      ...
      _TemplateSlot('Cable Seated Row', sets: 4, reps: 10),
      _TemplateSlot('Dumbbell Bent Over Row', sets: 3, reps: 10),
      _TemplateSlot('Barbell Shrug', sets: 3, reps: 12),
      _TemplateSlot('Dumbbell Reverse Fly', sets: 3, reps: 15),
      _TemplateSlot('Dumbbell Biceps Curl', sets: 3, reps: 12),
      _TemplateSlot('Dumbbell Hammer Curl', sets: 3, reps: 12),
    ],
  ),
  _RoutineTemplate(
    name: 'Leg Day · Volume',
    ...
    accent: _cPPL,
    slots: [
      _TemplateSlot('Barbell Front Squat', sets: 4, reps: 8),
      _TemplateSlot('Sled 45° Leg Press', sets: 4, reps: 12),
      _TemplateSlot('Lever Leg Extension', sets: 4, reps: 15),
      _TemplateSlot('Lever Seated Leg Curl', sets: 4, reps: 12),
      _TemplateSlot('Cable Pull Through (With Rope)', sets: 3, reps: 12),
      _TemplateSlot('Lever Seated Calf Raise', sets: 4, reps: 20),
    ],
  ),
  // ── Upper / Lower ─────────────────────────────────────────────────────────
  _RoutineTemplate(
    ...
    slots: [
      _TemplateSlot('Barbell Bench Press', sets: 4, reps: 6),
      _TemplateSlot('Barbell Bent Over Row', sets: 4, reps: 8),
      _TemplateSlot('Smith Standing Military Press', sets: 3, reps: 8),
  ...
  _RoutineTemplate(
    ...
    slots: [
      _TemplateSlot('Barbell Full Squat', sets: 4, reps: 6),
      _TemplateSlot('Barbell Straight Leg Deadlift', sets: 3, reps: 8),
      _TemplateSlot('Dumbbell Lunge', sets: 3, reps: 10),
      _TemplateSlot('Lever Leg Extension', sets: 3, reps: 15),
      _TemplateSlot('Lever Seated Calf Raise', sets: 4, reps: 15),
    ],
  ),
  // ── Powerbuilding ──────────────────────────────────────────────────────────
  _RoutineTemplate(
    ...
    accent: _cPower,
    slots: [
      _TemplateSlot('Barbell Bench Press', sets: 5, reps: 5),
      _TemplateSlot('Barbell Bent Over Row', sets: 5, reps: 5),
      _TemplateSlot('Smith Standing Military Press', sets: 4, reps: 6),
      _TemplateSlot('Pull-Up', sets: 3, reps: 8),
      _TemplateSlot('Barbell Curl', sets: 3, reps: 10),
      _TemplateSlot('Cable Triceps Pushdown (V-Bar)', sets: 3, reps: 12),
    ],
  ),
  _RoutineTemplate(
    name: 'Lower Power',
    ...
    slots: [
      ...
      _TemplateSlot('Barbell Good Morning', sets: 3, reps: 10),
      _TemplateSlot('Barbell Standing Calf Raise', sets: 4, reps: 12),
    ],
  ),
  // ── Bro Split ────────────────────────────────────────────────────────────
  _RoutineTemplate(
    ...
    accent: _cBro,
    slots: [
      _TemplateSlot('Barbell Bench Press', sets: 4, reps: 8),
      _TemplateSlot('Barbell Incline Bench Press', sets: 3, reps: 10),
      _TemplateSlot('Dumbbell Fly', sets: 3, reps: 12),
      _TemplateSlot('Chest Dip', sets: 3, reps: 10),
      _TemplateSlot('Barbell Lying Triceps Extension', sets: 3, reps: 12),
  ...
  _RoutineTemplate(
    ...
    slots: [
      _TemplateSlot('Barbell Deadlift', sets: 3, reps: 5),
      _TemplateSlot('Pull-Up', sets: 4, reps: 8),
      _TemplateSlot('Cable Seated Row', sets: 3, reps: 10),
      _TemplateSlot('Cable Pulldown', sets: 3, reps: 12),
      _TemplateSlot('Barbell Curl', sets: 3, reps: 10),
      _TemplateSlot('Dumbbell Incline Curl', sets: 3, reps: 12),
    ],
  ),
  _RoutineTemplate(
    name: 'Shoulders & Core',
    ...
    slots: [
      ...
      _TemplateSlot('Cable Lateral Raise', sets: 4, reps: 15),
      _TemplateSlot('Dumbbell Reverse Fly', sets: 3, reps: 15),
      _TemplateSlot('Barbell Upright Row', sets: 3, reps: 12),
  ...
  _RoutineTemplate(
    ...
    slots: [
      ...
      _TemplateSlot('Dumbbell Hammer Curl', sets: 3, reps: 12),
      _TemplateSlot('Barbell Lying Triceps Extension', sets: 3, reps: 12),
      _TemplateSlot('Dumbbell Incline Curl', sets: 3, reps: 15),
  ...
  _RoutineTemplate(
    ...
    slots: [
      ...
      _TemplateSlot('Barbell Bench Press', sets: 3, reps: 8),
      _TemplateSlot('Barbell Bent Over Row', sets: 3, reps: 8),
      _TemplateSlot('Weighted Front Plank', sets: 2, reps: 30),
      _TemplateSlot('Dumbbell Biceps Curl', sets: 2, reps: 12),
    ],
  ),
  _RoutineTemplate(
  ...
  _RoutineTemplate(
    ...
    slots: [
      _TemplateSlot('Barbell Deadlift', sets: 3, reps: 5),
      _TemplateSlot('Dumbbell Bench Press', sets: 3, reps: 10),
      _TemplateSlot('Cable Seated Row', sets: 3, reps: 10),
      _TemplateSlot('Dumbbell Goblet Squat', sets: 3, reps: 12),
      _TemplateSlot('Dumbbell Biceps Curl', sets: 2, reps: 12),
    ],
  ),
];
