            ...
            Center(
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(
                    // Wide enough for three tabular digits at full size so
                    // "99" → "100" never shrinks; FittedBox degrades gracefully
                    // (single line, never wraps) on narrow viewports and at
                    // large text scales.
                    width: 132,
                    height: 80,
                    child: FittedBox(
