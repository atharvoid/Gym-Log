...
class StepWeeklyGoal extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // One source of truth for the preview: you can never preview more
    // completed workouts than the goal itself, so at goal 1 the preview
    // shows 1/1 (100%), not the "2 workouts" used at higher goals.
    final completed = math.min(2, current);
    final double progress = completed / current;
            ...
            Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '$completed of $current workout${current == 1 ? '' : 's'} completed',
