...
class WorkoutTimer extends _$WorkoutTimer {
  ...
  void _updateElapsed(DateTime startTime) {
    ...
    if (elapsed.isNegative) {
      // Device clock moved backward (DST fall-back, manual clock change) —
      // never show a negative or garbled duration; hold at zero until the
      // clock catches back up to startTime.
