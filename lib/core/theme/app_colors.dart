...
abstract class AppColors {
  ...
  static const surface2 =
      Color(0xFF141414); // Surface 2 — elevated cards, charts, modals
  static const surface3 =
      Color(0xFF1C1C1C); // Surface 3 — inputs, +Add Set, secondary buttons
  ...
  static const surface2Light =
      Color(0xFFE0E0E3); // Surface 2 — elevated cards, charts, modals
  static const surface3Light =
      Color(0xFFD6D6D9); // Surface 3 — inputs, +Add Set, secondary buttons
  static const surface4Light =
      Color(0xFFCCCCCF); // Surface 4 — menus, action sheets, tooltips

  // ── Light borders — black at low opacity (mirror of dark white-opacity) ──
  static const borderSubtleLight =
      Color(0x1A000000); // black 10% — default card border
  static const borderDefaultLight =
      Color(0x33000000); // black 20% — interactive element border
  ...
  static const textTertiaryLight =
      Color(0x40000000); // black 25% — placeholders, column headers
  static const textDisabledLight =
      Color(0x26000000); // black 15% — inactive states
  ...
  static const borderSubtle =
      Color(0x0FFFFFFF); // white 6% — default card border
  static const borderDefault =
      Color(0x1AFFFFFF); // white 10% — interactive element border
  static const borderEmphasis =
      Color(0x2EFFFFFF); // white 18% — focused/selected
  static const borderActive = Color(
      0xFFBF5AF2); // neon purple — DEFAULT focus (reactive: context.accent.base)
  ...
  static const accentPrimary =
      Color(0xFFBF5AF2); // neon purple — default CTA/active/selected
  static const accentText =
      Color(0xFFD9A6FF); // neon purple LIGHT — default accent text on black
  static const accentDark = Color(0xFF9A3FD0); // neon purple pressed/depressed
  static const accentTint =
      Color(0x24BF5AF2); // neon purple 14% — default tinted fill
  static const accentBorder =
      Color(0x59BF5AF2); // neon purple 35% — default selected border
  static const accentGlow =
      Color(0x1FBF5AF2); // neon purple 12% — default atmospheric glow
  static const canvas =
      Color(0xFF0A0A0A); // High-contrast black for CTA background/text
  ...
  static const indigoTrack =
      Color(0x33BF5AF2); // neon purple 20% — generic ring track default
  static const chartAreaFill =
      Color(0x14BF5AF2); // neon purple 8% — chart area fill (subtle)

  // ── LAYER 2 — semantic accents (FIXED — never follow the brand accent) ──
  static const accentSuccess =
      Color(0xFF34C759); // iOS system green — completed sets / success
  static const accentInfo = Color(
      0xFF00D9FF); // (now unused by timer — see Task 3) kept for any info chips
  static const accentWarning =
      Color(0xFFFF9F0A); // amber — warm-up sets / warnings
  static const accentReward =
      Color(0xFFE6C84A); // PR celebration → GOLD (was magenta #FF2D55)
  static const rewardGold =
      Color(0xFFE6C84A); // IMMUTABLE — PR medal / trophy gold
  static const error =
      Color(0xFFFF3B30); // iOS system red — delete / errors ONLY

  // Semantic tints — same saturation ladder, fixed hues.
  static const successMark = accentSuccess;
  static const successTint =
      Color(0x2434C759); // green 14% — completed-set row bg
  static const infoMark = accentInfo; // 100% — rest-timer ring
  static const infoTint =
      Color(0x2400D9FF); // cyan 14% — rest-timer track / chip bg
  static const infoTrack =
      Color(0x3300D9FF); // cyan 20% — rest-timer ring track
  ...
  static const errorBorder =
      Color(0x99FF3B30); // red 60% — destructive button border
  ...
  static const profileGraphCurrentBar =
      Color(0xFFBF5AF2); // == accentPrimary default — current/latest week
  static const profileGraphCurrentBarBright =
      Color(0xFFD9A6FF); // == accentText default — touch highlight
  static const profileGraphHistoricalBar =
      Color(0xFF2C2C3A); // neutral cool-gray — previous weeks
  static const profileGraphInactiveBar =
      Color(0xFF2A2A3A); // in-progress week (mid-week, muted)
  static const profileGraphGhostBar =
