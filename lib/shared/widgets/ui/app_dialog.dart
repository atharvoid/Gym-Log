...
Future<bool> showAppConfirmDialog({
  ...
  assert(() {
    ...
    final looksDestructive =
        kDestructiveVerbs.any((v) => label.contains(v) || title0.contains(v));
  ...
  final result = await showModalBottomSheet<bool>(
    ...
    builder: (sheetCtx) {
      ...
      final cancelFg =
          isDestructive ? AppColors.textPrimary : surface.textSecondary;
                ...
                SizedBox(
                  ...
                  child: TextButton(
                    ...
                    child: Text(cancelLabel,
                        style: AppText.button(color: cancelFg)),
                  ),
                ),
              ],
            ),
